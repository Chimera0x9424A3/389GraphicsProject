...
public:
	...
	void render(double currentTime) {
        ...
        //Keep triangle position constant
	...
	GLuint compile_shaders(void) {
		...
		static const GLchar * fragment_shader_source[] = {
			...
			"void main(void)                                    \n"
			"{                                                  \n"
            "   color = vec4(sin(gl_FragCoord.x * 0.075) + 0.25, \n"
            "                sin(gl_FragCoord.y * 0.025) + 0.75, \n"
            "                sin(gl_FragCoord.x * 0.05) + 0.5,   \n"
            "                1.0);                              \n"
			"}                                                  \n"
		};
...
int main() {
	...
	GLFWwindow* terminal = glfwCreateWindow(900, 900, "Coates_HutchisonTriangle", nullptr, nullptr);

...
public:
    ...
    void startup() {
        faces = fillVerts("blender\\MuseumRedesign.obj", faces);
...
int main() {
    ...
    do {
        ...
        backward = glm::mat4(0.995, 0, 0, 0,
                             0, 0.995, 0, 0,
                            0, 0, 0.995, 0,
                            0, 0, 0, 1);

        forward = glm::mat4(1.005, 0, 0, 0,
                            0, 1.005, 0, 0,
                            0, 0, 1.005, 0,
                            0, 0, 0, 1);
        ...
        if (glfwGetKey(terminal, GLFW_KEY_C) == GLFW_PRESS) {
            ...
            myMatrix = glm::mat4(0.9993,     0,  0.0349,      0,
                                     0,     1,      0,      0,
                                 -0.0349,    0,  0.9993,      0,
                                      0,     0,      0,      1);
            rotateStuff(faces, myMatrix);
